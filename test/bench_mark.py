...
t = timeit.timeit("osgb.ll_to_grid(52 + 2 * random.random(), 0-3*random.random())",
        setup = "import random; import osgb",
        number=n*1000)
s = timeit.timeit("osgb.grid_to_ll(random.randrange(400000,500000), random.randrange(200000,500000))",
#s = timeit.timeit("osgb.grid_to_ll(393154.801, 177900.605)",
        setup = "import random; import osgb",
        number=n*1000)

print("Grid banger bench mark running under {} {} on {}".format(platform.python_implementation(), 
